...
for (const [label, opts] of [['phone', { ...devices['Pixel 7'] }], ['desktop', { viewport: { width: 1200, height: 800 } }]]) {
  ...
  await page.getByLabel('Back').click(); await page.waitForTimeout(300)
  ...
  await page.keyboard.press('Escape'); await page.waitForTimeout(300); await page.getByRole('button', { name: 'Home' }).click(); await page.waitForTimeout(300)
  ...
  await page.getByLabel('Back').click(); await page.waitForTimeout(300); await page.getByLabel('Back').click(); await page.waitForTimeout(300)
  await page.getByRole('button', { name: 'Data & backup' }).click(); await page.waitForTimeout(500); await shot('12-data')
  await page.getByRole('button', { name: 'Home' }).click(); await page.waitForTimeout(300); await page.getByRole('button', { name: 'Help' }).click(); await page.waitForTimeout(400); await shot('13-help')
  await ctx.close()
}
await browser.close()
console.log('done')
